"""
mycobot_csp verification launch.

Brings up:
  - ros2_control_node loading the MyCobotCSP plugin (CiA 402 CSP, mode 8)
  ...
  - forward_position_controller (after a 4s delay)

USAGE:
    ros2 launch mycobot_csp verify.launch.py

After all spawners are up, command absolute joint positions in radians:
...
def generate_launch_description():
    pkg_share = get_package_share_directory("mycobot_csp")
